...
public class LineQueue {
	...
	public LineQueue(PrintWriter init) {
		...
		try {
			...
			if (temp.equalsIgnoreCase("CRNL") || temp.equalsIgnoreCase("CRLF") || temp.equalsIgnoreCase("DOS")) {
				endOfLine = "\r\n";
			}
			else if (temp.equalsIgnoreCase("CR") || temp.equalsIgnoreCase("MAC")) {
				endOfLine = "\r";
			}
			else if (temp.equalsIgnoreCase("NL") || temp.equalsIgnoreCase("LF") || temp.equalsIgnoreCase("UNIX")) {
				endOfLine = "\n";
			}
			else {
				endOfLine = "\n";
