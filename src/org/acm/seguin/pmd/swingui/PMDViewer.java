 ...
 * @version $Revision: 1.2 $, $Date: 2003/09/21 20:51:41 $
 */
public class PMDViewer extends JFrame {
    ...
    public static final void run() {
        try {
            //FIXME? MRA LoadRootDirectories loadRootDirectories = new LoadRootDirectories();
            //FIXME? MRA loadRootDirectories.start();
            ...
            //FIXME? MRA SetupFilesEvent.notifySetFileList(pmdViewer, loadRootDirectories.getDirectories());
