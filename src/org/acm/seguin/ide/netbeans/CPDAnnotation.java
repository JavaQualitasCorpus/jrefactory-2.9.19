 ...
 * @author  mikea
 */
public class CPDAnnotation extends Annotation implements PropertyChangeListener {

	/** The error message shown on mouseover on the pmd icon */
	private String errormessage = null;
	private static List annotations = new ArrayList();
	
	private CPDAnnotation() {}
	
	public static final CPDAnnotation getNewInstance() {
		CPDAnnotation jra = new CPDAnnotation();
		annotations.add( jra );
		return jra;
	}
	...
	public String getAnnotationType() {
		return "jrefactory-cpd-annotation";
	}
