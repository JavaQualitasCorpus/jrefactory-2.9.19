...
/**
 *  Default implementation of the JRefactoryListener. The methods do nothing
 *  when invoked.
 *
 *@author     <a href="mailto:JRefactoryPlugin@ladyshot.demon.co.uk">Mike
 *      Atkinson</a>
 *@created    23 July 2003
 *@version    $Id: JRefactoryAdapter.java,v 1.1 2003/09/17 19:52:50 mikeatkinson Exp $
 *@since      0.0.1
 */
public class JRefactoryAdapter implements JRefactoryListener {
