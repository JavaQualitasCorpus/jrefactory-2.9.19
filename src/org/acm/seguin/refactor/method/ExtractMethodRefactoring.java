 ...
 *@version    $Id: ExtractMethodRefactoring.java,v 1.7 2003/10/30 15:24:23 mikeatkinson Exp $ 
 */
public class ExtractMethodRefactoring extends Refactoring
{
	...
	private SimpleNode getMethodTree()
	{
		...
		SimpleNode root = bpf.getAbstractSyntaxTree(false, ExceptionPrinter.getInstance());
	...
	private SimpleNode getFileRoot()
	{
		...
		SimpleNode root = bpf.getAbstractSyntaxTree(true, ExceptionPrinter.getInstance());
		return root;
	}
