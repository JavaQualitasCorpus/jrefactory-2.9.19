...
public class ParseException extends Exception
{
     ...
     *  This constructor calls its super class with the empty string to force
     *  the "toString" method of parent class "Throwable" to print the error
     *  message in the form: ParseException: <result of getMessage>
     *
     *@param  currentTokenVal            Description of Parameter
     *@param  expectedTokenSequencesVal  Description of Parameter
     *@param  tokenImageVal              Description of Parameter
     */
     ...
     *  during the printing of the final stack trace, and hence the correct
