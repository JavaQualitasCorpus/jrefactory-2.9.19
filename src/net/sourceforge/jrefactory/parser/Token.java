...
public class Token
{
     ...
     *  of this token; endLine and endColumn describe the position of the last
     ...
     *  there are more than one such special token, this field refers to the
     *  last of these special tokens, which in turn refers to the next previous
	...
	/**
	 *  Create a human readable representation of the named token
	 *
         *@param  b      flag to control output (not used at present)
	 *@return        A representation of the token 
         *@since         JRefactory 2.7.00
	 */
    public String toString(boolean b) {
        return "{token="+image+ " specialToken="+specialToken+"}";
    }
}
