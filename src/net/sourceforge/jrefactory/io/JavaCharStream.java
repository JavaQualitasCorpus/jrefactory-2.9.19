 ...
 *@version    $Id: JavaCharStream.java,v 1.1 2003/10/23 14:19:20 mikeatkinson Exp $ 
 *@since      2.8.00
 */

public class JavaCharStream extends CharStream {
  ...
  public char readChar() throws java.io.IOException
  {
     ...
     {
        if (c>127) {
           System.out.println("JavaCharStream: reading character='"+c+"'="+((int)c));
        }
        UpdateLineColumn(c);
        return (c);
     }
