 ...
 *@version     $Revision: 1.1 $ modified $Date: 2003/07/18 16:09:12 $ by
 *      $Author: mikeatkinson $
 *@since       MSNP2
 */
public class JEditBug_746217 extends StatefulCommand {
	...
	/**
	 *  Constructor for the JEditBug_746217 object
	 *
	 *@param  client   Description of Parameter
	 *@param  list     Description of Parameter
	 *@param  contact  Description of Parameter
	 */
	...
	//{{{ processAdd()
	/**
	 *  (ADD) notice/confirmation that a user was added to a list. <code>ADD 21 {FL|RL|AL|BL} listVersion example@passport.com example@passport.com</code>
	 *
	...
	/**
	 *  (ILN) A notification of the state of contacts when you first sign on. One
	 *  for each contact online is returned after your initial online status is
	 *  set. <P>
	 *
	 ...
	 *@param  transactionID  Description of Parameter
	 */
