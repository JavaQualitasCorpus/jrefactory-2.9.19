...
public class Outer extends GeneralOuter {
	...
	static int initial;
	private static final volatile int code=69;
	 ...
	 *@exception-error  IOException this is always thrown
	 *@param-error  theInt the value of myInt, but wrong name
	 */
	 ...
	 *  Description of the Method
	 */
	public static final synchronized void opsTest() {
		int x=3+2;
		int y=4*6>12?-2:~0xAF;
